(() => {
    const refs = {
      ...
      openTableRestModalBtn: document.querySelector('[data-table-rest-modal-open]'),
      closeTableModalBtn: document.querySelector('[data-table-modal-close]'),
      closeTableRestModalBtn: document.querySelector('[data-table-rest-modal-close]'),
    ...
    refs.openTableRestModalBtn.addEventListener('click', toggleTableRestModal);
    refs.closeTableModalBtn.addEventListener('click', toggleTableModal);
    refs.closeTableRestModalBtn.addEventListener('click', toggleTableRestModal);
